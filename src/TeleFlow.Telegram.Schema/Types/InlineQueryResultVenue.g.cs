...
/// </summary>
public sealed partial record class InlineQueryResultVenue : IJsonOnDeserialized
{
    /// <summary>
    ...
    void IJsonOnDeserialized.OnDeserialized()
    {
        if (Type != TypeValue)
        {
            throw new JsonException("Expected Telegram literal 'venue' for field 'type' on InlineQueryResultVenue.");
        }
