...
/// </summary>
public sealed partial record class InputRichBlockThinking : IJsonOnDeserialized
{
    /// <summary>
    ...
    void IJsonOnDeserialized.OnDeserialized()
    {
        if (Type != TypeValue)
        {
            throw new JsonException("Expected Telegram literal 'thinking' for field 'type' on InputRichBlockThinking.");
        }
