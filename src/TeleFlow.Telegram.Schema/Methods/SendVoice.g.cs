...
/// </remarks>
public sealed partial record class SendVoice : ITelegramApiMethod<Message>
{
    public static string MethodName => "sendVoice";
    ...
    [JsonRequired]
    public required InputFileString Voice { get; init; } = null!;
