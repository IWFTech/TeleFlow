...
public sealed class TelegramSchemaTests
{
    ...
    private static void AssertGeneratedHeader(string fileContents, string kind)
    {
        ...
        Assert.Contains("//   Source snapshot:", fileContents);
        Assert.Contains("//   Source SHA-256:", fileContents);
        ...
        Assert.Contains("//   Schema version: 6", fileContents);
        Assert.Contains("//   Generator version: 8", fileContents);
